...
const WhyChooseUs = () => {
  return (
    <section className="py-12 md:py-16 lg:py-20 bg-base-200 rounded-2xl overflow-hidden">
      <h2 className="text-3xl md:hidden block md:text-4xl font-bold mb-4 text-base-content leading-tight text-center">
      ...
      -top-1 left-16  md:left-40 z-20
       shadow-lg"
        ...
        <motion.div
          ...
          transition={{ duration: 0.6 }}
        >
          <h2 className="text-3xl md:block hidden md:text-4xl font-bold mb-4 text-base-content leading-tight">
            Why Choose <span className="text-yellow-400">Our Deals</span>?
          </h2>

          <p className="text-base-content/70 leading-relaxed mb-6 text-sm sm:text-base">
          ...
          <ul className="mb-6 space-y-2 text-base-content/80 text-sm sm:text-base">
